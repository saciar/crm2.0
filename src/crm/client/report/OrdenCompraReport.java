...
public class OrdenCompraReport extends CongressReportService implements OrdenCompraReportSEI {
	private static final String REPORT_OC_NAME = "jasper/oc.jasper";
	private static final String REPORT_OC_SALAS_NAME = "jasper/oc_salas.jasper";
	private static final String REPORT_OC_SERVICIOS_NAME = "jasper/oc_servicios.jasper";
	private static final String REPORT_OC_FOOTER = "jasper/oc_footer.jasper";
	
	private OrdenCompraReportSEI stub;
	private static OrdenCompraReport instance;
	private Date fechaEmision;	
	
	public OrdenCompraReport() throws WSIFException{
		super("OrdenCompraReportSEI");
	}
	
	protected void registerTypes() throws WSIFException {
		// map types
		try {
			addType("OrdenCompra", Class.forName("crm.libraries.report.OrdenCompra"));
			addType("OrdenCompraSalas", Class.forName("crm.libraries.report.OrdenCompraSalas"));
			addType("OrdenCompraServicio", Class.forName("crm.libraries.report.OrdenCompraServicio"));
			
			/*addType("ArrayOfOrdenFacturacion", Class.forName("crm.client.deserializer.ArrayOfOrdenFacturacion"));
			addType("ArrayOfOrdenFacturacionSalas", Class.forName("crm.client.deserializer.ArrayOfOrdenFacturacionSalas"));
			addType("ArrayOfOrdenFacturacionServicio", Class.forName("crm.client.deserializer.ArrayOfOrdenFacturacionServicio"));*/

		} catch (ClassNotFoundException e) {
			e.printStackTrace();
		}
		
		stub = (OrdenCompraReportSEI)service.getStub(OrdenCompraReportSEI.class);
	}

	public static OrdenCompraReport instance() {
		try {
			if (instance == null) {
	...
	public JasperPrint createOCReport(long nroPpto) throws RemoteException, JRException {
		...
		OrdenCompra[] ordenesFacturacion = findByNroPpto(nroPpto);
		String subTitle = createOCTitle(nroPpto);
	...
	private JasperPrint createReport(OrdenCompra[] ordenesFacturacion, String title, String subTitle) throws RemoteException, JRException {

		// 1- cargar los reporte desde los .jasper			
		JasperReport ofReport = (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream(REPORT_OC_NAME));
		JasperReport ofSalasReport = (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream(REPORT_OC_SALAS_NAME));
		JasperReport ofServiciosReport = (JasperReport)JRLoader.loadObject(getClass().getResourceAsStream(REPORT_OC_SERVICIOS_NAME));
	 ...
	 * @return
	 */
	public String createOCTitle(long nroPpto){
