...
public class OrdenFacturacionReport extends CongressReportService implements OrdenFacturacionReportSEI {
	...
	private OrdenFacturacionReportSEI stub;
	private static OrdenFacturacionReport instance;
	private Date fechaEmision;	
	
	public OrdenFacturacionReport() throws WSIFException{
		super("OrdenFacturacionReportSEI");
	}
	
	protected void registerTypes() throws WSIFException {
		// map types
		try {
			addType("OrdenFacturacion", Class.forName("crm.libraries.report.OrdenFacturacion"));
			addType("OrdenFacturacionSalas", Class.forName("crm.libraries.report.OrdenFacturacionSalas"));
			addType("OrdenFacturacionServicio", Class.forName("crm.libraries.report.OrdenFacturacionServicio"));
		...
		stub = (OrdenFacturacionReportSEI)service.getStub(OrdenFacturacionReportSEI.class);
	}

	public static OrdenFacturacionReport instance() {
		try {
			if (instance == null) {
	...
	public boolean sendOFByEmail (long nroPpto, String vendedorName) throws RemoteException{
		return stub.sendOFByEmail(nroPpto, vendedorName);
	}
	...
	public JasperPrint createOFReport(long nroPpto) throws RemoteException, JRException {
		...
		OrdenFacturacion[] ordenesFacturacion = findByNroPpto(nroPpto);
	...
	private JasperPrint createReport(OrdenFacturacion[] ordenesFacturacion, String title, String subTitle) throws RemoteException, JRException {
