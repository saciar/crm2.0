...
public class PorcentajeGerenciaReport extends CongressReportService implements PorcentajeGerenciaReportSEI {
	private static final String REPORT_PPTOS_GCIA_NAME = "jasper/PorcentajesGerencia.jasper";
	
	private PorcentajeGerenciaReportSEI stub;
	private static PorcentajeGerenciaReport instance;
	
	public PorcentajeGerenciaReport() throws WSIFException{
		super("PorcentajeGerenciaReportSEI");
	}
	...
	protected void registerTypes() throws WSIFException {
		...
		stub = (PorcentajeGerenciaReportSEI)service.getStub(PorcentajeGerenciaReportSEI.class);
	}
	
	public static PorcentajeGerenciaReport instance() {
		try {
			if (instance == null) {
				instance = new PorcentajeGerenciaReport();
			}
	...
	private JasperPrint createReport(PorcentajeGerencia[] eventos, String title, String subTitle, int year, 
		...
		if(e != null)
			jasperPrint = JasperFillManager.fillReport(eventReport, parameters, PptGerenciaReportDSBuilder.toJRMap(eventos,e.getDescripcion().equals("Nuevo")?"Pendiente":e.getDescripcion()));
		else
			jasperPrint = JasperFillManager.fillReport(eventReport, parameters, PptGerenciaReportDSBuilder.toJRMap(eventos,null));
...
class PptGerenciaReportDSBuilder{
