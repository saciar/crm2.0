...
public class PantallaAgendaCobranzas2 extends PantallaEmergente {
	...
	/*public PantallaAgendaCobranzas() {
		super();
	}*/	
	
	private PantallaCobranzas pantallaBienvenida;
	
	public PantallaAgendaCobranzas2(PantallaCobranzas pant) {
	...
	public void setupMiddle() {
		...
		try{
			panelVista = new PanelImagen("http://200.80.201.51:8888/app_files/Abstract_4220.jpg", false);
		}
		catch(Exception e){
		...
		btnRecordatorio.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/bell_add.png")
                    );
		...
		btnRecordatorio.setSelectedIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/bell_add_pressed.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
		...
		btnAcordado.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/money_add.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
		...
		btnAcordado.setSelectedIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/money_add_pressed.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
		...
		menuItem.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/ArreterSZ.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
	    ...
	    menuBorrar.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
        ...
        jPanel4Layout.setHorizontalGroup(
                ...
                .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel4Layout.createSequentialGroup()
                    ...
                    .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(org.jdesktop.layout.GroupLayout.TRAILING, jTable1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 942, Short.MAX_VALUE)
                        .add(jPanel4Layout.createSequentialGroup()
                            .add(btnAcordado, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 59, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(1, 1, 1)
                            .add(btnRecordatorio, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 59, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(jLabel25)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(nuevaTarea, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 349, Short.MAX_VALUE)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(jLabel7)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            ...
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                            .add(FechaTarea, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 132, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)))
                    .addContainerGap())
            );
            jPanel4Layout.setVerticalGroup(
                ...
                .add(jPanel4Layout.createSequentialGroup()
                    .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        ...
                        .add(btnRecordatorio)
                        .add(btnAcordado)
                        .add(FechaTarea, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(jLabel9)
                        .add(nuevaTarea, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .add(jLabel7)
                        .add(jFormattedTextField1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    .add(jTable1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 133, Short.MAX_VALUE)
                    .addContainerGap())
            );
        ...
        //btnEditar.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        btnnuevo.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/user_add.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
            ...
            panelVistaLayout.setHorizontalGroup(
                    panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, panelVistaLayout.createSequentialGroup()
                        .addContainerGap()
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jSeparator2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 974, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jSeparator1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 974, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel13)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(nroFactura, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 108, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jLabel15)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(fechaFactura, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 147, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(28, 28, 28)
                                .add(jLabel16)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(mora))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel8)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(lugarEvento, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 876, Short.MAX_VALUE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel3)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(contactoCliente, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 323, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(60, 60, 60)
                                .add(jLabel5)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(fechaEvento, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 147, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(22, 22, 22)
                                .add(jLabel6)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(comercial, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel11)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(cmbContactoPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 236, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(btnEditar)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(btnnuevo)
                                ...
                                .add(jLabel18)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(txtTelContacto, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 150, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jLabel19)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(txtEmailContacto, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 140, Short.MAX_VALUE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel20)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(txtDireccionPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 417, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jLabel21)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(txtHorariosPago, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 397, Short.MAX_VALUE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jSeparator4, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 974, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel22)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(cmbTipoCobrador, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 242, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .add(55, 55, 55)
                                .add(jLabel23)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(formaPago, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 487, Short.MAX_VALUE))
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVistaLayout.createSequentialGroup()
                                .add(jLabel24)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jScrollPane1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 887, Short.MAX_VALUE)))
                        .addContainerGap())
                );
                panelVistaLayout.setVerticalGroup(
                    panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(panelVistaLayout.createSequentialGroup()
                        .addContainerGap()
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel13)
                            .add(nroFactura)
                            .add(jLabel15)
                            .add(fechaFactura, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(mora)
                            .add(jLabel16))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        ...
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            ...
                            .add(contactoCliente)
                            .add(jLabel5)
                            .add(fechaEvento, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jLabel6)
                            .add(comercial))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                        ...
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel11)
                            .add(cmbContactoPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(btnEditar)
                            .add(btnnuevo)
                            .add(jLabel18)
                            .add(txtTelContacto)
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(txtDireccionPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jLabel21)
                            .add(jLabel20)
                            .add(txtHorariosPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(jSeparator4, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 10, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(jLabel22)
                            .add(cmbTipoCobrador, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(jLabel23)
                            .add(formaPago))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelVistaLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(jLabel24)
            ...
            btnGrabar.setIcon(new javax.swing.JLabel() {
                public javax.swing.Icon getIcon() {
                    try {
                        return new javax.swing.ImageIcon(
                            new java.net.URL("http://200.80.201.51:8888/app_files/disk.png")
                        );
                    } catch (java.net.MalformedURLException e) {
                    }
                    return null;
            ...
            btnSalir.setIcon(new javax.swing.JLabel() {
                public javax.swing.Icon getIcon() {
                    try {
                        return new javax.swing.ImageIcon(
                            new java.net.URL("http://200.80.201.51:8888/app_files/door_out.png")
                        );
                    } catch (java.net.MalformedURLException e) {
                    }
                    return null;
            ...
            btnSiguiente.setIcon(new javax.swing.JLabel() {
                public javax.swing.Icon getIcon() {
                    try {
                        return new javax.swing.ImageIcon(
                            new java.net.URL("http://200.80.201.51:8888/app_files/application_side_expand.png")
                        );
                    } catch (java.net.MalformedURLException e) {
                    }
                    return null;
            ...
            btnAnterior.setIcon(new javax.swing.JLabel() {
                public javax.swing.Icon getIcon() {
                    try {
                        return new javax.swing.ImageIcon(
                            new java.net.URL("http://200.80.201.51:8888/app_files/application_side_contract.png")
                        );
                    } catch (java.net.MalformedURLException e) {
                    }
                    return null;
            ...
            layout.setHorizontalGroup(
                    ...
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, panelVista, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                                .add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 438, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel5, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 294, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(jPanel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE))
                            .add(layout.createSequentialGroup()
                                .add(jLabel12)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(nombreCliente, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 613, Short.MAX_VALUE)
                                .add(128, 128, 128)
                                .add(jLabel10)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(btnAnterior)
                ...
                layout.setVerticalGroup(
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            ...
                            .add(jLabel10))
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(panelVista, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(jPanel1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(jPanel5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(jPanel2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 114, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                );
    ...
    private void loadAgenda(String nroPpto) {
    	if(nroPpto != null){
    		try {		
    			...
    			AgendaPpto cobrador = AgendaPptoManager.instance().getDataById(nroPpto);
    			
    			if(cobrador != null){
    				cmbTipoCobrador.setForeign(cobrador.getCodCobrador());
    				if(!cobrador.getCodContacto().equals("0")){
    					cmbContactoPago.setForeign(cobrador.getCodContacto());
    				}
    				if(!StringUtils.isBlank(cobrador.getDireccionPago())){
    					txtDireccionPago.setText(cobrador.getDireccionPago());
    				}
    				if(!StringUtils.isBlank(cobrador.getHorarioPago())){
    					txtHorariosPago.setText(cobrador.getHorarioPago());
    				}
    				/*if(!StringUtils.isBlank(cobrador.getPorcentaje())){
    					jFormattedTextField1.setText(cobrador.getPorcentaje());
    				}*/
    			}
    			
    			loadEstados();
    			
    			AgendaTareasCobranzas[] agendas = AgendaTareasCobranzasManager.instance().findByField("numeroPresupuesto",nroPpto);
	...
	public void loadData(CobranzasItem it){
		...
		if(it.getObservaciones() != null)
			...
			jTextArea1.setText("");
		totalEvento = (Double.parseDouble(it.getImporteTotal())*1.21)-(Double.parseDouble(it.getAdelanto())*1.21);
		jLabel35.setText(getTotalFormateado(Double.parseDouble(it.getImporteTotal())*1.21));
		jLabel31.setText(getTotalFormateado(Double.parseDouble(it.getAdelanto())*1.21));
		jLabel33.setText(getTotalFormateado((Double.parseDouble(it.getImporteTotal())*1.21)-(Double.parseDouble(it.getAdelanto())*1.21)));
	...
	private class GrabarActionListener implements ActionListener{
		...
		private AgendaPpto createAgenda(){
			AgendaPpto entity = new AgendaPpto();
				...
				if(String.valueOf(nroPpto)!= null && cmbTipoCobrador.searchForeign() != null && 
						cmbContactoPago.searchForeign() != null && String.valueOf(jFormattedTextField1.getText())!= null){
				...
				for(int i=0;i<model.getRowCount(); i++){
					...
					try {								
						...
						if(i==model.getRowCount()-1)
							Util.alertMsg(Main.getVentana(),"La agenda se guardó con éxito");
					} catch (RemoteException e) {
