...
public class ABMModoIngreso extends ABMGeneral{
	private javax.swing.JFormattedTextField jFormattedTextField1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JSeparator jSeparator1;
	
    private ModoIngEquipos modoIngreso;
	private JPanel panel;
	private String entidadBuscada;
	
	public ABMModoIngreso(JPanel pan){
		panel = pan;	
	}
	...
	public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de un modo de ingreso de equipos");

        jLabel2.setText("Ingrese el nombre del modo de ingreso de equipos");
	...
	private void setAddMode() {
		this.modoIngreso = new ModoIngEquipos();
		resetFields();
	}
	
	public void setEditMode(String entityId) {
		try {
			this.modoIngreso = ModoIngEquiposManager.instance().getById(entityId);
			resetFields();
	...
	private void resetFields() {
		jFormattedTextField1.setText(modoIngreso.getDescripcion());
	}
	...
	public void guardar() {
		...
		this.modoIngreso.setDescripcion(nombreTipoEvento);
		try {
			ModoIngEquiposManager.instance().update(this.modoIngreso);
			Util.alertMsg(Main.getVentana(), "El modo de ingreso de equipos se guardó con éxito");
		} catch (Exception e) {
			Util.errMsg(Main.getVentana(), "Error al guardar el modo de ingreso de equipos",e);
		} finally {
			setAddMode();
		}
	}
	...
	public void buscar(){
		ABMModoIngresoBusqueda busq = new ABMModoIngresoBusqueda(Main.getVentana());
		busq.initComponents();
