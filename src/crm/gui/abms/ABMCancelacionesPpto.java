...
import crm.gui.Main;
import crm.gui.abms.busquedas.ABMCancelacionPptoBusqueda;
import crm.gui.abms.busquedas.ABMValidezPptoBusqueda;
import crm.libraries.abm.entities.PrtPptoCancelacion;

public class ABMCancelacionesPpto extends ABMGeneral{
	...
	private PrtPptoCancelacion model;
	
	public ABMCancelacionesPpto(JPanel pan){
		panel = pan;	
	}
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de una nueva cancelación de presupuestos");

        jLabel7.setIcon(new javax.swing.ImageIcon(getUrlImagen("DibujoCancelacion.jpg")));

        jLabel2.setText("Ingrese el titulo de la cancelación");
    ...
    public void guardar() {        
        ...
        try {			        	
        	...
        	PrtPptoCancelacionManager.instance().update(this.model);			
    ...
    private void setAddMode(){
    	this.model = new PrtPptoCancelacion();    	
    	this.resetFields();
    }
    
    public void setEditMode(String entityId){
    	 try {    		  		
    		 this.model = PrtPptoCancelacionManager.instance().getById(entityId);    	
    		 this.resetFields();
    	 }catch (RemoteException e) {		
			e.printStackTrace();
		}
    ...
    public void buscar(){
    	ABMCancelacionPptoBusqueda busq = new ABMCancelacionPptoBusqueda(Main.getVentana());
		busq.initComponents();
