...
import crm.gui.Main;
import crm.gui.abms.busquedas.ABMEstadosEventoBusqueda;
import crm.gui.abms.busquedas.ABMTipoEventoBusqueda;
import crm.libraries.abm.entities.EstadoEvento;

public class ABMEstadosEvento extends ABMGeneral{
	private javax.swing.JFormattedTextField jFormattedTextField1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JSeparator jSeparator1;
	
    private EstadoEvento tipoEvento;
	private JPanel panel;
	private String entidadBuscada;
	
	public ABMEstadosEvento(JPanel pan){
		panel = pan;	
	}
	...
	public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de un estado de evento");

        jLabel2.setText("Ingrese el nombre del estado de evento");
	...
	private void setAddMode() {
		this.tipoEvento = new EstadoEvento("S","");
		resetFields();
	}
	
	public void setEditMode(String entityId) {
		try {
			this.tipoEvento = EstadoEventoManager.instance().getEstadoEventoById(entityId);
			resetFields();
	...
	public void guardar() {
		...
		try {
			EstadoEventoManager.instance().update(this.tipoEvento);
			Util.alertMsg(Main.getVentana(), "El estado de evento se guardó con éxito");
		} catch (Exception e) {
			Util.errMsg(Main.getVentana(), "Error al guardar el estado de evento",e);
		} finally {
			setAddMode();
		}
	}
	...
	public void buscar(){
		ABMEstadosEventoBusqueda busq = new ABMEstadosEventoBusqueda(Main.getVentana());
		busq.initComponents();
