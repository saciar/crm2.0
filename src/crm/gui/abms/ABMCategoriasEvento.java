...
import crm.gui.Main;
import crm.gui.abms.busquedas.ABMCategoriasEventoBusqueda;
import crm.gui.abms.busquedas.ABMTipoEventoBusqueda;
import crm.libraries.abm.entities.CategEvento;

public class ABMCategoriasEvento extends ABMGeneral{
	private javax.swing.JFormattedTextField jFormattedTextField1;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JSeparator jSeparator1;
	
    private CategEvento categoriaEvento;
	private JPanel panel;
	private String entidadBuscada;
	
	public ABMCategoriasEvento(JPanel pan){
		panel = pan;	
	}
	...
	public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de una categoria de evento");

        jLabel2.setText("Ingrese el nombre de la categoria de evento");
	...
	private void setAddMode() {
		this.categoriaEvento = new CategEvento("","","S");
		resetFields();
	}
	
	public void setEditMode(String entityId) {
		try {
			this.categoriaEvento = CategEventoManager.instance().getCategEventoById(entityId);
			resetFields();
	...
	private void resetFields() {
		jFormattedTextField1.setText(categoriaEvento.getDescripcion());
	}
	...
	public void guardar() {
		...
		this.categoriaEvento.setDescripcion(nombreTipoEvento);
		try {
			CategEventoManager.instance().update(this.categoriaEvento);
			Util.alertMsg(Main.getVentana(), "La categoria de evento se guardó con éxito");
		} catch (Exception e) {
			Util.errMsg(Main.getVentana(), "Error al guardar la categoria de evento",e);
		} finally {
			setAddMode();
		}
	}
	...
	public void buscar(){
		ABMCategoriasEventoBusqueda busq = new ABMCategoriasEventoBusqueda(Main.getVentana());
		busq.initComponents();
