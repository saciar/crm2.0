...
public class ABMValidezPpto extends ABMGeneral{
	...
	private PrtPptoValidez model;
	
	public ABMValidezPpto(JPanel pan){
		panel = pan;	
	}
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de una nueva validez de presupuestos");

        jLabel7.setIcon(new javax.swing.ImageIcon(getUrlImagen("DibujoValidez.jpg")));

        jLabel2.setText("Ingrese el titulo de la validez");
    ...
    public void guardar() {        
        ...
        try {			        	
        	...
        	PrtPptoValidezManager.instance().update(this.model);			
    ...
    private void setAddMode(){
    	this.model = new PrtPptoValidez();    	
    	this.resetFields();
    }
    
    public void setEditMode(String entityId){
    	 try {    		  		
    		 this.model = PrtPptoValidezManager.instance().getById(entityId);    	
    		 this.resetFields();
    	 }catch (RemoteException e) {		
			e.printStackTrace();
		}
    ...
    public void buscar(){
    	ABMValidezPptoBusqueda busq = new ABMValidezPptoBusqueda(Main.getVentana());
		busq.initComponents();
