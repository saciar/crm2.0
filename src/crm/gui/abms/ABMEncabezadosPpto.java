...
public class ABMEncabezadosPpto extends ABMGeneral {
	...
	private PrtPptoHeader model;
	
	public ABMEncabezadosPpto(JPanel pan){
		panel = pan;	
	}
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de un nuevo encabezado de presupuestos");

        jLabel7.setIcon(new javax.swing.ImageIcon(getUrlImagen("DibujoEncabezado.jpg")));

        jLabel2.setText("Ingrese el titulo del encabezado");
    ...
    public void guardar() {        
        ...
        try {			        	
			...
			PrtPptoHeaderManager.instance().update(this.model);			
    ...
    private void setAddMode(){
    	this.model = new PrtPptoHeader();    	
    	this.resetFields();
    }
    
    public void setEditMode(String entityId){
    	 try {    		  		
    		 this.model = PrtPptoHeaderManager.instance().getById(entityId);    	
    		 this.resetFields();
    	 }catch (RemoteException e) {		
			e.printStackTrace();
		}
    ...
    public void buscar(){
    	ABMEncabezadosPptoBusqueda busq = new ABMEncabezadosPptoBusqueda(Main.getVentana());
		busq.initComponents();
