...
public class ABMPeriodosPptoBusqueda extends JDialog{
	...
	public void initComponents() {
        ...
        jLabel1.setText("B\u00fasqueda de períodos");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel2.setText("Buscar por:");

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Nombre del período");
        jRadioButton1.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        jRadioButton1.setMargin(new java.awt.Insets(0, 0, 0, 0));
        jRadioButton1.setSelected(true);
        
        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("C\u00f3digo del período");
    ...
    private void setCodigoText(){
    	...
    	jFormattedTextField2.setForeground(new java.awt.Color(153, 153, 153));
        jFormattedTextField2.setText("Ingrese el c\u00f3digo del período a buscar");
        jFormattedTextField2.setFont(new java.awt.Font("SansSerif", 2, 12));
    }
...
//*********************************ACCIONES*******************************************/
    ...
    private class BorrarActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(it != null){
				try {
					if (MessageUtil.showYesNoMessage(ABMPeriodosPptoBusqueda.this, "¿Seguro que desea borrar el período seleccionado?", "Borrar")){
					...
					Util.errMsg(Main.getVentana(), "Error al borrar el período",e);
				}				
			}
    	...
    	public void actionPerformed(ActionEvent arg0) {
    		try{
    			...
    			if(jRadioButton1.isSelected() && !StringUtils.isBlank(jFormattedTextField1.getText())){
    				...
    				Util.errMsg(Main.getVentana(),"Ingrese un nombre del período a buscar",null);
    			}
    			else if(jRadioButton2.isSelected() && StringUtils.isBlank(jFormattedTextField2.getText())){
    				Util.errMsg(Main.getVentana(),"Ingrese un codigo del período a buscar",null);
    			}
    			...
    			Util.errMsg(Main.getVentana(), "Error al buscar el período",e);
    		}
    	}
