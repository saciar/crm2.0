...
public class ABMTiposPptoBusqueda extends JDialog{
    ...
    public ABMTiposPptoBusqueda(Frame owner){
    	super(owner);
    	this.setTitle("Buscar Tipo de presupuestos");
	...
	public void initComponents() {
        ...
        jLabel1.setText("B\u00fasqueda de tipos de presupuestos");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 11));
        jLabel2.setText("Buscar por:");

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Nombre del tipo de presupuesto");
        jRadioButton1.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        jRadioButton1.setMargin(new java.awt.Insets(0, 0, 0, 0));
        jRadioButton1.setSelected(true);
        
        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("C\u00f3digo del tipo de presupuesto");
            ...
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/application_form_edit.png")
                    );
        ...
        jButton3.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/application_form_delete.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
        ...
        jButton1.setIcon(new javax.swing.JLabel() {
            public javax.swing.Icon getIcon() {
                try {
                    return new javax.swing.ImageIcon(
                        new java.net.URL("http://200.80.201.51:8888/app_files/magnifier.png")
                    );
                } catch (java.net.MalformedURLException e) {
                }
                return null;
    ...
    private void setCodigoText(){
    	...
    	jFormattedTextField2.setForeground(new java.awt.Color(153, 153, 153));
        jFormattedTextField2.setText("Ingrese el c\u00f3digo del tipo de presupuesto a buscar");
        jFormattedTextField2.setFont(new java.awt.Font("SansSerif", 2, 12));
    }
...
//*********************************ACCIONES*******************************************/
    ...
    private class SalirActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			if (MessageUtil.showYesNoMessage(ABMTiposPptoBusqueda.this, "¿Desea salir del formulario de busqueda?", "Salir")){
    ...
    private class BorrarActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(it != null){
				try {
					if (MessageUtil.showYesNoMessage(ABMTiposPptoBusqueda.this, "¿Seguro que desea borrar el tipo de presupuesto seleccionado?", "Borrar")){
						PrtPptoTipoPresupuestoManager.instance().remove(it.getCodigo());
						((BusquedaBasicTableModel)jTable1.getTable().getModel()).removeRow(it);
						jTable1.refreshTable();	
					}
				} catch (RemoteException e) {
					Util.errMsg(Main.getVentana(), "Error al borrar el tipo de presupuesto",e);
				}				
			}
    ...
    private class BuscarActionListener implements ActionListener{
    	...
    	public void actionPerformed(ActionEvent arg0) {
    		try{
    			PrtPptoTipoPresupuesto[] encabezados = null;
    			if(jRadioButton1.isSelected() && !StringUtils.isBlank(jFormattedTextField1.getText())){
    				encabezados  = PrtPptoTipoPresupuestoManager.instance().findByField("descripcion",jFormattedTextField1.getText());
    			}
    			else if(jRadioButton2.isSelected() && !StringUtils.isBlank(jFormattedTextField2.getText())){
    				PrtPptoTipoPresupuesto enc = PrtPptoTipoPresupuestoManager.instance().getById(jFormattedTextField2.getText());
    				if(enc != null){
    					encabezados = new PrtPptoTipoPresupuesto[1];
    					encabezados[0] = enc; 
    				}
    			}    			
    			else if(jRadioButton1.isSelected() && StringUtils.isBlank(jFormattedTextField1.getText())){
    				Util.errMsg(Main.getVentana(),"Ingrese un nombre de tipo de presupuesto a buscar",null);
    			}
    			else if(jRadioButton2.isSelected() && StringUtils.isBlank(jFormattedTextField2.getText())){
    				Util.errMsg(Main.getVentana(),"Ingrese un codigo de tipo de presupuesto a buscar",null);
    			}
    			...
    			if(encabezados != null && encabezados.length >0){
    				...
    				for(int i=0; i<encabezados.length;i++){
    					...
    					item.setCodigo(encabezados[i].getCodigo());
    					item.setNombre(encabezados[i].getDescripcion());
    			...
    			Util.errMsg(Main.getVentana(), "Error al buscar el tipo de presupuesto",e);
    		}
    	}
