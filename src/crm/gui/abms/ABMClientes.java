...
import crm.gui.pantalla.BuscadorLocalidades;
...
public class ABMClientes extends ABMGeneral{
	...
	private String codClienteBuscada;
	
    public ABMClientes(JPanel pan){
		panel = pan;	
	}
    ...
    public void initComponents() {
		...
		m_txtEmpresa = CustomTextField.getNameInstance(150);
		...
		m_txtCalle = CustomTextField.getNameInstance(50);
		...
		f_txtFacCalle = CustomTextField.getNameInstance(50);
		...
		f_txtFacDomicilioPago = CustomTextField.getRegularStringInstance(30);
		f_cmbFacCodProveedor = CustomTextField.getRegularStringInstance(20);
		f_txtFacFechaHoraPago = CustomTextField.getRegularStringInstance(30);
        ...
        jLabel36.setText("*Nota: estos campos son obligatorios para la grabaci\u00f3n del nuevo cliente, con excepci\u00f3n del c\u00f3digo postal.");
                        ...
                        .add(layout.createSequentialGroup()
                            ...
                            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                ...
                                .add(layout.createSequentialGroup()
                                    ...
                                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(layout.createSequentialGroup()
                                            .add(m_txtCalle, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 465, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(jLabel13)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                        ...
                                        .add(layout.createSequentialGroup()
                                            ...
                                            .add(jLabel20)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(m_cmbCodigoPostal, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 208, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(btnBuscarLocalidades))
                                        .add(layout.createSequentialGroup()
                                            .add(m_cmbPais, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 194, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(jLabel17)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(m_cmbProvincia, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 202, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(jLabel18)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(m_cmbPartido, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 195, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))))
                                .add(layout.createSequentialGroup()
                                    .add(jLabel19)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbLocalidad, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 196, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .add(jLabel21)
                                .add(layout.createSequentialGroup()
                                    .add(jLabel22)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(f_txtFacCalle, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 465, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(jLabel23)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                ...
                                .add(layout.createSequentialGroup()
                                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                        ...
                                        .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                                            .add(jLabel32)
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(f_txtFacDomicilioPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 293, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                        .add(layout.createSequentialGroup()
                                            .add(jLabel33)
                                ...
                                .add(layout.createSequentialGroup()
                                    .add(jLabel29)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbFacLocalidad, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 200, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(jLabel30)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbFacCodigoPostal, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 206, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(btnBuscarLocalidadesFac))
                                .add(layout.createSequentialGroup()
                                    .add(jLabel26)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbFacPais, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 199, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(jLabel27)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbFacProvincia, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 205, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(jLabel28)
                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                    .add(m_cmbFacPartido, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 193, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                                .add(layout.createSequentialGroup()
                                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                            ...
                                            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING, false)
                                                ...
                                                .add(org.jdesktop.layout.GroupLayout.LEADING, layout.createSequentialGroup()
                                                    ...
                                                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                                                        .add(m_txtNombreFantasia)
                                                        .add(m_txtEmpresa, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 386, Short.MAX_VALUE))))
                                            .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                            .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                                                .add(layout.createSequentialGroup()
                                                    .add(jLabel5)
                                                    ...
                                                    .add(jLabel7)
                                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                    .add(m_cmbCondIVA, 0, 186, Short.MAX_VALUE))
                                                .add(layout.createSequentialGroup()
                                                    .add(jLabel4)
                                                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                                    .add(jLabel6)
	...
	public void guardar() {
		...
		try {
			...
			if (!StringUtils.isBlank(clienteID)) {
				...
				Util.alertMsg(Main.getVentana(), "El cliente se cargó con éxito");
				
			}
		} catch (WSIFException e) {
			Util.errMsg(Main.getVentana(), "Error al guardar el cliente",e);
		} catch (RemoteException e) {
			Util.errMsg(Main.getVentana(), "Error al guardar el cliente",e);
		} finally {
			setAddMode();
	...
	public void buscar(){
		...
		ABMClientesBusqueda busq = new ABMClientesBusqueda(Main.getVentana());
		busq.initComponents();
		busq.setVisible(true);
		codClienteBuscada  = busq.getCodEntidadElegido();
		if(codClienteBuscada != null){
			ProgressDialogUtil.setType(ProgressDialogUtil.LOAD_PPTO_TYPE);
			ProgressDialogUtil.launchProcessDialog(Main.getVentana());
			new Thread(new Runnable() {	
				public void run() {
					setEditMode(codClienteBuscada);
