...
import crm.gui.Main;
import crm.gui.abms.busquedas.ABMTiposPptoBusqueda;
import crm.libraries.abm.entities.PrtPptoTipoPresupuesto;

public class ABMTiposPpto extends ABMGeneral{
	...
	private PrtPptoTipoPresupuesto model;
	
	public ABMTiposPpto(JPanel pan){
		panel = pan;	
	}
    ...
    public void initComponents() {
        ...
        jLabel1.setText("Creaci\u00f3n de un nuevo tipo de presupuestos");

        jLabel7.setIcon(new javax.swing.ImageIcon(getUrlImagen("DibujoTipoPpto.jpg")));

        jLabel2.setText("Ingrese el titulo del tipo");
    ...
    public void guardar() {        
        ...
        try {			        	
        	...
        	PrtPptoTipoPresupuestoManager.instance().update(this.model);			
    ...
    private void setAddMode(){
    	this.model = new PrtPptoTipoPresupuesto();    	
    	this.resetFields();
    }
    
    public void setEditMode(String entityId){
    	 try {    		  		
    		 this.model = PrtPptoTipoPresupuestoManager.instance().getById(entityId);    	
    		 this.resetFields();
    	 }catch (RemoteException e) {		
			e.printStackTrace();
		}
    ...
    public void buscar(){
    	ABMTiposPptoBusqueda busq = new ABMTiposPptoBusqueda(Main.getVentana());
		busq.initComponents();
