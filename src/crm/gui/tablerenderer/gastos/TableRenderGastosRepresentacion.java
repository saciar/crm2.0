...
public class TableRenderGastosRepresentacion extends TableRender {
	
	public TableRenderGastosRepresentacion() {
		this(new ArrayList());
	}
	
	public TableRenderGastosRepresentacion(List rows) {
		super(new GastosRepresentacionTableModel(rows));
		...
		//setupDetalle(table.getColumnModel().getColumn(GastosRepresentacionTableModel.COLUMNA_DETALLE));
	...
	public GastosRepresentacionItem getSelectedItem(){
		
		// obtengo el modelo de la tabla
		GastosRepresentacionTableModel model = (GastosRepresentacionTableModel)getTable().getModel();
...
//		 obtengo el numero de linea seleccionada de la vista
		...
		GastosRepresentacionItem item = model.getRow(selrow);	
	...
	public void removeSelection(){
		((GastosRepresentacionTableModel)getTable().getModel()).removeRow(getSelectedItem());
		getTable().updateUI();
	}
