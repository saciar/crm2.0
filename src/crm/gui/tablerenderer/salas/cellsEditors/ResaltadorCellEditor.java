...
public class ResaltadorCellEditor extends JTextField implements TableCellRenderer {
	...
	public ResaltadorCellEditor(String o){
    	ocurrencia =o;
	...
	public Component getTableCellRendererComponent(JTable table, Object value,boolean isSelected, boolean hasFocus, int row, int col) {
		...
		if(value != null){
			...
			if(value.toString().toLowerCase().contains(ocurrencia.toLowerCase())){			
	...
	public void search(String value) {
        ...
        int index = value.indexOf(ocurrencia.toLowerCase(), 0);
        if (index >= 0) {
            try {
