...
public class MargenesRealTableCellRenderer extends DefaultTableCellRenderer{

    public MargenesRealTableCellRenderer()
    {
    ...
    {   
    	...
    	Double total = (Double)table.getModel().getValueAt(row, 13);
