...
public class PantallaBienvenidaCobranzas extends PantallaBienvenidaVerdadera{
    ...
    public PantallaBienvenidaCobranzas() {
		super();
	...
	public void initComponents() {
        ...
        agendas.setIcon(new javax.swing.ImageIcon(getUrlImagen("magnifier.png")));
        ...
        agendas.addActionListener(new agendasCobradasActionListener());
        ...
        layout.setHorizontalGroup(
            ...
            layout.setVerticalGroup(
                ...
                .add(layout.createSequentialGroup()
                    ...
                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    .add(jTable1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE)
                    .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                    .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                            .add(buscar)
    ...
    private void reportesActionPerformed (java.awt.event.ActionEvent evt) {
    	/*BuscadorReportesCobranzas buscador = new BuscadorReportesCobranzas(Main.getVentana());
		buscador.init();
    ...
    private class agendasCobradasActionListener implements ActionListener{
    	
    
		public void actionPerformed(ActionEvent e) {
			BuscadorAgendasCobradas buscador = new BuscadorAgendasCobradas(Main.getVentana());
	    	buscador.setPantallaBienvenida(PantallaBienvenidaCobranzas.this);
			buscador.init();
