...
public class BuscadorClientesEnPptoFact extends PantallaEmergente{
    ...
    private FacturacionPanel panelCliente;
    
	public BuscadorClientesEnPptoFact(Frame owner, FacturacionPanel panel) {
		super("Buscador de clientes de facturcion", owner);
		panelCliente=panel;
				...
				try{		
					...
					if (razonSocialRadioButton.isSelected()){
						...
						if (codesAndFantasyNames != null && codesAndFantasyNames.length > 0){
							...
							MessageUtil.showMessage(BuscadorClientesEnPptoFact.this, "No se encontró ningún cliente con los datos especificados");
						}
	...
	private class SalirActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			if (MessageUtil.showYesNoMessage(BuscadorClientesEnPptoFact.this, "¿Desea salir sin seleccionar ningún cliente?",
	...
	private class OkActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {
				...
				panelCliente.setClienteElegido(selectedClient);
			} catch (RemoteException e) {
				e.printStackTrace();
			}
			...
			else MessageUtil.showMessage(BuscadorClientesEnPptoFact.this, "Debe selecionarse un cliente primeramente.");
		}
