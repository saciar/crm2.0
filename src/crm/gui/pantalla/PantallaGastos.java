...
import crm.gui.pantalla.PantallaFacturacion.PopupListener;
...
public class PantallaGastos extends PantallaEmergente {

	private BuscadorReportesServiciosTableRender tableRender;
	...
	public PantallaGastos(Frame owner){
		super("Presupuestos pendientes de imputacion de gastos",owner);
		pptoElegido = null;
	}
	...
	public void initComponent() {
        ...
        tableRender = new BuscadorReportesServiciosTableRender();
        jCheckBox1 = new javax.swing.JCheckBox();
        jTextField1 = new javax.swing.JTextField();
        jSeparator2 = new javax.swing.JSeparator();

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 20));
        jLabel1.setText("Presupuestos con subcontratados");
