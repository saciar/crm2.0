...
public class BuscadorClientesAvanzada extends PantallaEmergente{
    ...
    private NuevaBusquedaAvanzada padre;
    private int tipoBusqueda;
	public BuscadorClientesAvanzada(Frame owner, NuevaBusquedaAvanzada e, int tb) {
				...
				try{		
					...
					if (razonSocialRadioButton.isSelected()){
						...
						if (codesAndFantasyNames != null && codesAndFantasyNames.length > 0){
							...
							MessageUtil.showMessage(BuscadorClientesAvanzada.this, "No se encontró ningún cliente con los datos especificados");
						}
	...
	private class SalirActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			if (MessageUtil.showYesNoMessage(BuscadorClientesAvanzada.this, "¿Desea salir sin seleccionar ningún cliente?",
	...
	private class OkActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try {				
				...
				padre.setClienteElegido(selectedClient,tipoBusqueda);
			} catch (RemoteException e) {
				e.printStackTrace();
			}
			...
			else MessageUtil.showMessage(BuscadorClientesAvanzada.this, "Debe selecionarse un cliente primeramente.");
		}
