...
public class BuscadorClientesEnPpto extends PantallaEmergente{
	...
	public BuscadorClientesEnPpto(Frame owner, ClientePanel panel) {
				...
				try{		
					...
					if (razonSocialRadioButton.isSelected()){
						...
						if (codesAndFantasyNames != null && codesAndFantasyNames.length > 0){
							...
							MessageUtil.showMessage(BuscadorClientesEnPpto.this, "No se encontró ningún cliente con los datos especificados");
						}
	...
	private class SalirActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			if (MessageUtil.showYesNoMessage(BuscadorClientesEnPpto.this, "¿Desea salir sin seleccionar ningún cliente?",
	...
	private class OkActionListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			else MessageUtil.showMessage(BuscadorClientesEnPpto.this, "Debe selecionarse un cliente primeramente.");
		}
