...
public class TabPresupuestos {
    ...
    public TabPresupuestos(BuscadorReportes o){
	...
	private class BuscarActionListener implements ActionListener{
		...
		private void buscarReportes(){
			try {
				...
				setCriteria();
				presupuestos = PresupuestosManager.instance().buscarParaReportes(codCliente, codClienteFact,fechaDesde,fechaHasta,codLugar,codCondPago,estado,codTipoEvento,codServicio, null);
