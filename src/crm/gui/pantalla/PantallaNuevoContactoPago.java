...
public class PantallaNuevoContactoPago extends JDialog{
	    ...
	    private ClienteContactoCobranza contacto;
	    ...
	    public PantallaNuevoContactoPago(Frame owner, Cliente clienteId){
			
			super(owner);
			this.setTitle("Nuevo contacto de Pago");
	    ...
	    public void init(){
	        ...
	        jLabel1.setText("Creaci\u00f3n de nuevo contacto de pago de");
	        ...
	        nuevo.setIcon(new javax.swing.JLabel() {
	        ...
	        salir.setIcon(new javax.swing.JLabel() {
	            public javax.swing.Icon getIcon() {
	                try {
	                    return new javax.swing.ImageIcon(
	                        new java.net.URL("http://200.80.201.51:8888/app_files/arrow_down.png")
	                    );
	                } catch (java.net.MalformedURLException e) {
	                }
	                return null;
	    ...
	    private void setAddMode() {
			this.contacto = new ClienteContactoCobranza();;
			resetFields();
		}
	    
	    public void setEditMode(String entityId) {
			try {			
				this.contacto = ClienteContactoCobranzaManager.instance().getClienteContactoById(entityId);
		 ...
		 */
		public ClienteContactoCobranza getContacto() {
			return contacto;
		}
		 ...
		 */
		public void setContacto(ClienteContactoCobranza contacto) {
...
//	************************************ACCIONES************************************************
		private class SalirActionListener implements ActionListener{
			...
			public void actionPerformed(ActionEvent arg0) {
				if (MessageUtil.showYesNoMessage(PantallaNuevoContactoPago.this, "¿Desea salir sin guardar cambios?", "Salir") == true){
					setVisible(false);
			...
			public void actionPerformed(ActionEvent arg0) {
				if (formValid()){				
					try {			
						...
						contacto.setFechaUltimoContacto(new Date());		            
			            ...
			            codContactoElegido = ClienteContactoCobranzaManager.instance().update(contacto);
			            if(!StringUtils.isBlank(codContactoElegido))
			            	contacto.setCodigo(codContactoElegido);
			            
			            MessageUtil.showMessage(PantallaNuevoContactoPago.this,"El contacto del cliente se cargó con éxito");

					} catch (RemoteException e) {			
						//MessageUtil.showErrorMessage(PantallaNuevoContactoCliente.this,"Error al guardar los datos");
						MessageUtil.showMessage(PantallaNuevoContactoPago.this,"Error al cargar datos externos");
					}
					finally {
						//setAddMode();
						setVisible(false);
					...
					MessageUtil.showMessage(PantallaNuevoContactoPago.this,"Faltan datos por completar");
				}
			}
