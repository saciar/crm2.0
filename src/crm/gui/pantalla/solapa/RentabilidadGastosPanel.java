...
public class RentabilidadGastosPanel extends PanelGeneral implements PanelInterface{
    ...
    public void setMainPanel(MainPanelGastos mainPanel) {
		this.mainPanel = mainPanel;
	}     
    
    public RentabilidadGastosPanel(JPanel pan){
    	panel = pan;
    }
